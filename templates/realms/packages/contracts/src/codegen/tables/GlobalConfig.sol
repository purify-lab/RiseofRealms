...
library GlobalConfig {
   ...
   */
  function getUnStakeFee() internal view returns (uint256 unStakeFee) {
   ...
   * @notice Get unStakeFee.
   */
  function _getUnStakeFee() internal view returns (uint256 unStakeFee) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set unStakeFee.
   */
  function _setUnStakeFee(uint256 unStakeFee) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
