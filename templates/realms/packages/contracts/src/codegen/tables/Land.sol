...
library Land {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "Land", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004c616e64000000000000000000000000);

  FieldLayout constant _fieldLayout =
    FieldLayout.wrap(0x00a7080002202020202004010000000000000000000000000000000000000000);
  ...
  // Hex-encoded value schema of (uint16, bytes32, uint256, uint256, uint256, uint256, uint32, bool)
  Schema constant _valueSchema = Schema.wrap(0x00a70800015f1f1f1f1f03600000000000000000000000000000000000000000);
  ...
  /**
   * @notice Get attackAble.
   */
  function getAttackAble(uint16 id) internal view returns (bool attackAble) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
   ...
   * @notice Get attackAble.
   */
  function _getAttackAble(uint16 id) internal view returns (bool attackAble) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
  ...
  /**
   * @notice Set attackAble.
   */
  function setAttackAble(uint16 id, bool attackAble) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));

    StoreSwitch.setStaticField(_tableId, _keyTuple, 7, abi.encodePacked((attackAble)), _fieldLayout);
  }

  /**
   * @notice Set attackAble.
   */
  function _setAttackAble(uint16 id, bool attackAble) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));

    StoreCore.setStaticField(_tableId, _keyTuple, 7, abi.encodePacked((attackAble)), _fieldLayout);
  }

  /**
   * @notice Get the full data.
   */
  function get(uint16 id) internal view returns (LandData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
   ...
   * @notice Get the full data.
   */
  function _get(uint16 id) internal view returns (LandData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
   ...
   */
  function set(uint16 id, LandData memory _table) internal {
    bytes memory _staticData = encodeStatic(
      _table.tileId,
      _table.owner,
      _table.infantry,
   ...
   * @notice Set the full data using the data struct.
   */
  function _set(uint16 id, LandData memory _table) internal {
    bytes memory _staticData = encodeStatic(
      _table.tileId,
      _table.owner,
      _table.infantry,
    ...
    )
  {
    ...
    infantry = (uint256(Bytes.getBytes32(_blob, 34)));

    cavalryA = (uint256(Bytes.getBytes32(_blob, 66)));

    cavalryB = (uint256(Bytes.getBytes32(_blob, 98)));

    cavalryC = (uint256(Bytes.getBytes32(_blob, 130)));

    lastTime = (uint32(Bytes.getBytes4(_blob, 162)));

    attackAble = (_toBool(uint8(Bytes.getBytes1(_blob, 166))));
  }
  ...
  function decode(
    ...
    EncodedLengths,
    bytes memory
  ) internal pure returns (LandData memory _table) {
    (
      _table.tileId,
      _table.owner,
      _table.infantry,
  ...
  function encodeStatic(
    ...
    return abi.encodePacked(tileId, owner, infantry, cavalryA, cavalryB, cavalryC, lastTime, attackAble);
  }
