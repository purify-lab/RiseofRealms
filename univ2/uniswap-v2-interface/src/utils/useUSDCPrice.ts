import { ChainId, Currency, currencyEquals, JSBI, Price, WETH } from '@im33357/uniswap-v2-sdk'
...
export default function useUSDCPrice(currency?: Currency): Price | undefined {
  ...
  const tokenPairs: [Currency | undefined, Currency | undefined][] = useMemo(
    () => [
      ...
      [wrapped?.equals(USDC) ? undefined : wrapped, chainId === ChainId.RedStone ? USDC : undefined],
      [chainId ? WETH[chainId] : undefined, chainId === ChainId.RedStone ? USDC : undefined]
    ],
